...
export function MailInp(){
    return(
                 <div className= '  inpboxesofform '>
                    <span className="material-symbols-outlined pr-2 pl-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</span><input type="text" placeholder='Email' name="" id=""  className='w-[91%] p-1.5 border-0 border-transparent text-[20px] '/>
                </div>
...
<path d="M8 11V7C8 5.93913 8.42143 4.92172 9.17157 4.17157C9.92172 3.42143 10.9391 3 12 3C13.0609 3 14.0783 3.42143 14.8284 4.17157C15.5786 4.92172 16 5.93913 16 7V11" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <input type="password" placeholder='Password' name="" id=""  className='h-[80%] w-[91%] border-0 border-transparent text-[20px] p-1.5 '/>
                </div>
        </>
    )
}
