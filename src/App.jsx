    ...
    <div className="flex align-baseline gap--59 w-[90vw] h-[100vh]">
      <div className=" headings  w-[50vw] h-[85vh] m-10 mt-14 ml-14 pl-10  ">
        <div>
            ...
            <div>
              <div className="py-3">
                ...
                <input
                  ...
                  name=""
                  id=""
                  className="p-1.5 border-0 border-transparent text-[20px] "
                />
              </div>
              ...
              <div className="py-1.5">
                ...
                <input
                  ...
                  name=""
                  id=""
                  className="border-0 border-transparent text-[20px] p-1.5 "
                />
              </div>
              <div className="flex justify-between w-[80%] mt-8">
                <p className=" text-[20px] ml-2 font-[500] ">
          ...
          <p className="text-[18px] font-[200] mt-[5vh] mx-[10.5vw] my-[1.2vh]">
            Or sign in with
          </p>
          <div className="flex justify-between w-[27vw] mt-[3vh]">
            <div className="flex ">
              <button className="flex">
                ...
                <span className="font-[500] p-[0.2em] pl-[0.6vw]">Google</span>
              </button>{" "}
            </div>
            <div>
              <button className="flex">
                ...
                <span className="font-[500] p-[0.2em] pl-[0.2vw]">
                  Facebook
                </span>
              </button>
            </div>
